...
function FormField<T extends FieldValues>({ name, autoComplete, inputType, label, register, errors, rules, value, inputClassName, labelClassName, placeholder }: Field<T> & { value?: string; inputClassName?: string; labelClassName?: string; placeholder?: string }) {
